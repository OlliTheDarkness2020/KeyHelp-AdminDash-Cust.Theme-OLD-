...
sub _createKeyhelpMailgraphPicture
{
    ...
    RRDs::graph(
        ...
        @RRDArgs,
        'COMMENT: Letztes Update\:['.$setDate.']\r',
    );
...
my $mailGraphs = keyhelpMailgraph->new(
	...
	mailgraphRRDFile => '/home/keyhelp/www/keyhelp/theme/otd/assets/tools/mailgraph/mailgraph.rrd',
	mailgraphVirusRRDFile => '/home/keyhelp/www/keyhelp/theme/otd/assets/tools/mailgraph/mailgraph_virus.rrd',
	mailgraphGreylistRRDFile => '/home/keyhelp/www/keyhelp/theme/otd/assets/tools/mailgraph/mailgraph_greylist.rrd',
	xPoints => 540,
	pointsPerSample => 3,
	yPoints => 96,
	dayRange => $dayRange,
