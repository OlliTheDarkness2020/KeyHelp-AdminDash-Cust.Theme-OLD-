...
/* --------- Dienste STATUS --------- */
echo $stylecss;
			echo '<div align="center"><u>Letztes Update</u> <br /> '.date ("d.m.Y H:i:s", time()).' Uhr</div>
			<div class="table-container">
            <table class="table is-fullwidth is-striped">
				<colgroup>
	...
	case 'raid':
		echo $stylecss;
				...
				echo '
				<div align="center"><u>Letztes CronJob Update</u> <br /> ' .date ("d.m.Y H:i", filemtime($raid)). ' Uhr</div>
				<div class="table-container">
				<table class="table is-fullwidth is-striped">
					<colgroup>
	...
	case 'smart':
		echo $stylecss;
					...
					echo '
					<div align="center"><u>Letztes CronJob Update</u> <br /> '.date ("d.m.Y H:i", filemtime($smart)).' Uhr</div>
					<div class="table-container">
						<table class="table is-fullwidth is-striped">
						<colgroup>
							<col span="1" style="width: 60%;">
							...
							<tr>
								...
								<td>
									<center>
										...
										<a onclick="getStat(\'stop\', '.$item[2].', \''.$item[0].$item[2].'\')">
											<i class="far fa-stop-circle fa-lg"></i>
										</a>
									<!--
										<a onclick="getStat(\'del\', '.$item[2].', \''.$item[0].$item[2].'\')">
						...
						';
						...
						catch(Exception $e)
							{
							  ...
							  echo '
								<tr>
									<td> <b> ---- </b> </td>
									<td> <center> <h4>' . $item[0] . '</h4> <h4>' . $item[2] . '</h4> </center> </td>
									<td>
										<center>
											<font class="tab blink" color="red"> Offline </font>
											<a onclick="getStat(\'start\', '.$item[2].', \''.$item[0].$item[2].'\')">
			...
			if ($tscontrol == 'start')
				{
					if ($tsdebug === "ohyes")
						...
						{
							$ts3id = $ts3->serverIdGetByPort(9987);

							$ts3->serverStart($ts3id);
						}

					echo '{"servinst": "<b> Server gestartet ! </b>"}';
			...
			if ($tscontrol == 'stop')
				{
					...
					echo '{"servinst": "<b> Server gestoppt ! </b>"}';
